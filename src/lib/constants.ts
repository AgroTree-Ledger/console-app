import { AlbumIcon, CircleUserRoundIcon, FileTextIcon, ImagesIcon, StoreIcon } from "lucide-react";
...
export const DASHBOARD_MENU = [
  ...
  {
    name: 'Reports', href: '/console/reports', icon: FileTextIcon
  },
  { name: "Marketplace", href: "https://marketplace.soltion.store", icon: StoreIcon },
